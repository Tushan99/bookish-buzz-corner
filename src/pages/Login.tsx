        ...
        <div className="text-center animate-fade-in">
          <div className="flex justify-center">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-2xl font-bold text-gray-900">BookVerse</span>
            </div>
          </div>
        ...
        <div className="bg-white rounded-xl shadow-lg p-8 animate-scale-in">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full bg-blue-600 text-white py-3 px-4 rounded-lg font-medium hover:bg-blue-700 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed hover-scale"
            >
              {isLoading ? (
